...
enforceRateLimit('client-register', 5, 3600);
$data = jsonInput();
...
if ($existingClient->fetchColumn()) respond(['error' => 'Ya existe una ficha con ese correo. Solicita al SPA que habilite tu acceso.'], 409);
