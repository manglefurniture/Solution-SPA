(()=>{
  try{
    ...
    window.addEventListener('DOMContentLoaded',()=>{
      ...
      const product=document.createElement('script');product.src='productization.js?v=20260824-payflow1';document.body.appendChild(product);
      const payments=document.createElement('script');payments.src='payments-ui.js?v=20260824-payflow1';document.body.appendChild(payments);
    });
